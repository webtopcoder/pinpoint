        ...
        <SimpleBar style={{ height: "900px" }}>
          ...
          <Row style={{ marginTop: 20 }}>
            <Col md={8} sm={8} xs={8} style={{ textAlign: 'center', paddingTop: 10 }}>
              {token && <div><Badge dot={true}><Image src={mailIcon} alt="mail" width={60} height={40} /></Badge></div>}
          ...
          <Row className="sidebar-menu-item" onClick={() => handleOriginPageRender('/user/map/interactive-map')}>
            Home
          </Row>
