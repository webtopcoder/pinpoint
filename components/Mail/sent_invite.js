        ...
        <Row className='mail-inbox'>
            <Col md={24} sm={24} xs={24}>
                <Card>
                    ...
                    <Form form={composeForm} layout="vertical" onFinish={onFinish} autoComplete="off">
                        <Form.Item
                            name="email"
                        ...
                        <Form.Item name="message" label="Add a personalized message to the invitation (optional)">
