    ...
    >
      ...
      >
        <Row>
          ...
          <Col xs={24} sm={24} md={24} lg={24} xl={24}>
            ...
            >
              <Select
                ...
                options={[{ label: 'Owner', value: 'Owner' }, { label: 'Event Manager', value: 'Event Manager' }]}
                onChange={changeType}
              />
            </Form.Item>
          </Col>
          <Col xs={24} sm={24} md={24} lg={24} xl={24}>
            <Form.Item
              tooltip="This is a required field for Event manager"
              label="Access Events"
              rules={[
                {
                  required: type === "Event Manager" ? true : false
                },
              ]}
              name="locations"
            >
              <Select
                disabled={type === "Event Manager" ? false : true}
                mode="multiple"
                showSearch={false}
                allowClear
                style={{
          ...
          <Col xs={24} sm={24} md={12} lg={12} xl={12} style={{
            ...
            <div className={styles.role_title}>Event Manager</div>
