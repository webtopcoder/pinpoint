...
function Posts({ loading, initLoading, user_id, list, data, LoadMoreAllStatus, setLoading, setList, allActivities, ondownloadFile }) {
    const pattern = /@\w+/g;
    ...
    return (
        <Card>
            <CardBody className="px-1">
                    ...
                    {list?.map((item, index) => (
                        <li className="event-list" key={item?._id}>
                            ...
                            <div className="d-flex">
                                ...
                                <div className={classnames('flex-grow-1', { 'font-size-14': isWebDevice }, { 'font-size-14': !isWebDevice })}>
                                    <div>
                                        {item?.type === "follow" && <>
                                            <PopUserBox
                                        ...
                                        {item?.type === "post" || item?.type == "review" ? <p className="mt-2 text-muted font-size-14">{item.content}</p> : ''}
                ...
                <div className="text-center mt-4"><a className="btn btn-danger waves-effect waves-light btn-sm" onClick={onLoadMore}>View More <i className="bx bx-plus"></i></a></div>
            </CardBody>
        </Card>
    );
}
